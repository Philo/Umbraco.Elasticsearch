...
using Umbraco.Elasticsearch.Samplev74.Features.Search.Models;
using Umbraco.Elasticsearch.Samplev74.Features.Search.Queries.Article;
using Umbraco.Web.Models;
using Umbraco.Web.Mvc;

namespace Umbraco.Elasticsearch.Samplev74.Features.Search.Controllers
{
